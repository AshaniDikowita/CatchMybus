...
declare var google;
/**
 * Generated class for the DriverRoute page.
 *
...
export class DriverRoute {
  ...
  constructor(public navCtrl: NavController, public geolocation: Geolocation,angFire:AngularFire,public alerCtrl: AlertController) {
    this.busstops = angFire.database.list("/busstop");
    console.log("data: " + this.busstops);

    this.busstops.subscribe((bus) => console.log("kk : " + bus.lat));
  }
